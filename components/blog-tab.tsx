  ...
  const posts = [
    {
      ...
      excerpt: "React 18에서 소개된 Concurrent Features와 Automatic Batching에 대해 알아봅시다.",
      date: "2024.11.15",
      category: "React",
      readTime: "5 min",
    ...
    },
    {
      ...
      excerpt: "이미지 최적화, 코드 스플리팅, 캐싱 전략으로 Next.js 앱의 성능을 극대화하세요.",
      date: "2024.11.10",
      category: "Next.js",
      readTime: "8 min",
    ...
    },
    {
      ...
      excerpt: "타입 시스템을 활용하여 런타임 에러를 줄이고 더 안전한 코드를 작성하는 방법.",
      date: "2024.11.05",
      category: "TypeScript",
      readTime: "6 min",
    ...
    },
    {
      ...
      excerpt: "현대적인 스타일링 솔루션들을 비교 분석하고 선택 기준을 알아봅시다.",
      date: "2024.10.28",
      category: "CSS",
      readTime: "7 min",
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6">
        {posts.map((post) => (
          <article key={post.id} className="bg-card rounded-lg p-6 sm:p-8 card-hover border border-border">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between sm:gap-4 mb-4">
              ...
              <span className="text-xs text-muted-foreground mt-3 sm:mt-0 whitespace-nowrap">{post.readTime}</span>
            </div>
